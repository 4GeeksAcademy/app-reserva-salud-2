...
export const VistaNuevoRegistroUnificado = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="container contenido mb-5"
          ...
          <Form className="row bg-gray p-3 rounded-bottom">
            <div className="mb-3">
              ...
              <Field
                ...
                name="email"
              />
              <ErrorMessage className="text-normal text-primary" name="email" />
            </div>
            <div className="mb-3">
            ...
            <div className="p-2 mb-3 form-check">
              ...
              <ErrorMessage
                name="rol"
                component="div"
                className="text-normal text-primary"
              />
            </div>
            ...
            <div className="mb-3 form-check">
              <label className="text-label p-2">
                ...
                />
                He leído los{" "}
                <Link onClick={abrirModal} className="text-primary">
                  términos y condiciones
                </Link>
              </label>
              <ErrorMessage className="text-normal text-primary" component="div" name="terms_and_conditions" />
            </div>
