                ...
                {({ handleSubmit, values }) => (
                    <Form onSubmit={handleSubmit} className="container mx-auto min-h-screen pt-20">
                        <div className="rounded-box border border-base-300 bg-base-200">
                            <div className="flex items-center justify-between rounded-t-box bg-base-300 px-8 py-4 text-primary">
                                <h3 className="text-2xl font-bold">Ingresa tus datos</h3>
                                <i className="fa-solid fa-circle-user fa-3x text-secondary"></i>
                            </div>
                            <div className="flex flex-col rounded-b-box bg-base-200 px-8 py-4">
                                <div className="flex flex-col md:flex-row gap-4">
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="first_name" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="last_name" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col md:flex-row gap-4">
                                    <div className="form-control w-full">
                                        ...
                                        />
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="birth_date" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="gender" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col md:flex-row gap-4">
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="state_id" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="city_id" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col md:flex-row gap-4">
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="speciality_id" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="telephone" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col md:flex-row gap-4">
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="profile_picture" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-control w-full">
                                        ...
                                        <div className="label">
                                            <ErrorMessage className="label-text" component="span" name="certificate" />
                                        </div>
                                    </div>
                                </div>
