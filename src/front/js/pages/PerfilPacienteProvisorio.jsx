...
export const VistaPerfilPaciente = () => {
  ...
  return (
    <div className="container min-h-screen mx-auto pt-20">
      ...
      <h3 className="text-2xl font-bold text-center pb-2">Profesionales destacados</h3>
      ...
      <div className="text-center pt-3">
        <Link to="/profesionales" className="btn btn-primary">
          <i className="fa-solid fa-user-plus"></i> Agendar nueva cita
        </Link>
      </div>

      <h3 className="text-2xl font-bold">Todas las citas</h3>
