            ...
            <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="text-title text-center">Términos y condiciones</h1>
                        <button
                            type="button"
                            className="btn-close"
                            aria-label="Close"
                    ...
                    <div className="modal-body">
                        ...
                        <p className="text-normal">Para cualquier consulta, comuníquese con nosotros a través de nuestros canales de contacto, disponibles en la sección Contacto.</p>
                    </div>
